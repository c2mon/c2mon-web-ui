...
class GenerateStatisticsTask {
   ...
   */
  @Value("${c2mon.web.statistics.chartConfigLocation:}")
  ...
  public void generateStatistics() {
    ...
    if (chartConfigLocation == null || chartConfigLocation.isEmpty()) {
      logger.info("Not generating statistics as \"c2mon.web.statistics.chartConfigLocation\" property was not supplied.");
      return;
    }
