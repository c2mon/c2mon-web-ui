 ...
 *****************************************************************************/
package cern.c2mon.web.ui.legacy.statistics.charts;
...
import cern.c2mon.web.ui.legacy.statistics.C2MONChartStyles;
import cern.c2mon.web.ui.legacy.statistics.StatisticsMapper;
import cern.c2mon.web.ui.legacy.statistics.exceptions.GraphConfigException;
import cern.c2mon.web.ui.legacy.statistics.exceptions.InvalidTableNameException;
...
public abstract class WebChartCollection {
    ...
    public static final WebChartCollection fromXML(final Element chartElement, C2MONChartStyles C2MONChartStyles, final StatisticsMapper mapper)
