      ...
      <div id="tab-content" class="tab-content">
          <div class="tab-pane fade in active" id="id">
            <form class="well form-inline" action="" method="post" onsubmit="this.submit.disabled = true;">
              ...
              <input class="form-control" style="display: inline" type="text" id="id" oninput="numOnly(this.id);" name="id" value="${formTagValue}" placeholder="${formTagPlaceHolder} ID" maxlength="9" pattern="[0-9]{1,9}"/>
          ...
          <div class="tab-pane fade" id="name">
            <form class="well form-inline" action="" method="post" onsubmit="this.submit.disabled = true;">
               ...
               <div class="input-group">
                 ...
                 <input class="form-control" style="display: inline" type="text" id="faultCode" oninput="numOnly(this.id);" name="faultCode" value="${formTagValue}" maxlength="9" pattern="[0-9]{1,9}"/>
               </div>
               <input class="btn btn-large btn-primary" type="submit" value="Submit" name="submit">
            </form>
          </div>
